...
public class about extends JFrame {
	...
	public about() {
		...
		panel.setBounds(0, 11, 533, 146);
		contentPane.add(panel);
		
		JLabel label = new JLabel("");
		ImageIcon icon =new ImageIcon(about.class.getResource("/Image/\u0E42\u0E25\u0E42\u0E01\u0E49\u0E2A\u0E35\u0E02\u0E32\u0E27.png"));
		label.setBounds(95, 19, 119, 95);
		int offset = label.getInsets().left;
		label.setIcon(resizeIcon(icon, label.getWidth() - offset, label.getHeight() - offset));
		panel.add(label);
